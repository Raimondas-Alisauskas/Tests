...
public class ProposalPriceCalculator {
     ...
     * <p>
     * public double programing; //= programingTime (EarlyFinishDateCalculator)* programmingRate (ProducerInput)
     * <p>
     * public double production; //= processingTime (EarlyFinishDateCalculator)* machineUsageRate (ProducerInput)
     * <p>
